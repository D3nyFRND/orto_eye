<template>
  <footer>
    <div class="logoNav">
      <img src="../../assets/footer/logoFooter.svg" />
      <nav>
    ...
    <hr />
    <div class="bottom">
      <span>Copyright OrtoEye 2023 All Right Reserved</span>
      <span>Projekt i realziacja: Artneo.pl</span>
    </div>
  </footer>
</template>
...
<style lang="scss" src="./footerDefault.scss" scoped></style>
